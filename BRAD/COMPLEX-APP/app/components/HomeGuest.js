	...
	function ourReducer (draft, action) {
		switch (action.type) {
			case 'usernameImmediately':
				...
				if (draft.username.value && !/^([a-zA-Z0-9]+)$/gi.test(draft.username.value)) {
					draft.username.hasErrors = true
			...
			case 'emailAfterDelay':
				if (!/^\S+@\S+$/gi.test(draft.email.value)) {
			...
			<div className="row align-items-center">
				<div className="col-lg-7 py-3 py-md-5">
					...
					<p className="lead text-muted">Are you sick of short tweets and
												   ...
												   reminiscent of the late 90&rsquo;s email forwards? We believe getting
												   back to actually
				...
				<div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
					<form onSubmit={ handleSubmit }>
						<div className="form-group">
							...
							<CSSTransition in={ state.username.hasErrors }
										   timeout={ 330 }
						...
						<div className="form-group">
							...
							<input onChange={ e => dispatch({ type: 'emailImmediately', value: e.target.value }) }
								   ...
								   autoComplete="off" />
							<CSSTransition in={ state.email.hasErrors }
										   timeout={ 330 }
										   classNames={ 'liveValidateMessage' }
										   unmountOnExit>
						...
						<div className="form-group">
							...
							<CSSTransition in={ state.password.hasErrors }
										   timeout={ 330 }
										   classNames={ 'liveValidateMessage' }
										   unmountOnExit>
